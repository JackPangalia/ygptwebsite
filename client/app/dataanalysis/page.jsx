    ...
    <div className="pt-[8rem]">
      <section className="sm:mt-20 mt-14 max-w-[1500px] px-[2rem] mx-auto">
        <div className = 'w-full flex lg:flex-row flex-col gap-10'>
          <h1 className="lg:text-6xl text-5xl lg:w-1/2 w-full">Data Analysis</h1>
        ...
        <Image src = '/analysis.jpg' alt = 'chat bot img' height = {2000} width = {2000} className = 'w-full mt-20 max-h-[800px] object-cover'/>
