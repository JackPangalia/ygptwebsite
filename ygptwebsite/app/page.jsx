      ...
      <div className="pt-[8rem]">
        ...
        <section className="bg-black md:py-32 py-20 md:mt-40 mt-24 text-white">
          <div className="px-[2rem] max-w-[1500px] mx-auto">
            <h2 className="sm:text-5xl text-3xl" id="services">
              Our Services
            </h2>
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8 mt-16">
              <div className="bg-red-300 lg:min-h-[22rem] min-h-[14rem] text-black p-8">
                <svg
                  fill="currentColor"
                  viewBox="0 0 16 16"
                  height="2em"
                ...
                <h4 className="text-red-900 text-2xl mb-4">
                  Chat Bot Development
                </h4>
                <p className="sm:text-lg text-sm mb-8 text-red-900">
              ...
              <div className="bg-blue-300 lg:min-h-[22rem] min-h-[14rem] text-black p-8">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  height="2em"
                ...
                <h4 className="text-2xl mb-4 text-blue-950">
                  Autonomous Agents
                </h4>
                <p className="sm:text-lg text-sm mb-8 text-blue-950">
              ...
              <div className="bg-green-300 lg:min-h-[22rem] min-h-[14rem] text-black p-8">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  height="2em"
                  width="2em"
                  className="text-green-950 mb-6"
                >
              ...
              <div className="bg-purple-300 lg:min-h-[22rem] min-h-[14rem] text-black p-8">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  height="2em"
                  width="2em"
                  className="text-purple-950 mb-6"
                >
                ...
                <h4 className="text-2xl text-purple-950 mb-4">Data Analysis</h4>
                <p className="sm:text-lg text-sm text-purple-950 mb-8">
        ...
        <section
          className="w-full px-[3rem] max-w-[1500px] mx-auto py-20 sm:py-40"
          id="benifits"
        >
          <h2 className="sm:text-5xl text-3xl mb-16">Why Implement AI?</h2>
        ...
        <section className="bg-black py-52  text-white">
          <div className="px-[2rem] max-w-[1500px] mx-auto">
            <h2 className="mb-2 text-5xl bg-gradient-to-r from-red-300 via-blue-300 to-green-300 text-transparent bg-clip-text w-fit font-semibold">
              Learn More About Us With AI
            </h2>
            <p className="mb-10 w-1/2 text-gray-500">
            ...
            <Link
              href="/chatbot"
              className=" border-white border-[1px] text-white px-6 py-2 text-sm border-dashed hover:bg-white hover:text-black transition-all duration-300"
            >
              Try it out
            </Link>
          </div>
        ...
        <section className="w-full border-b-[1px] border-black py-40 lg:px-[3rem] px-[1.5rem] max-w-[1500px] mx-auto">
          <h2 className="text-5xl w-1/2 mb-16">
